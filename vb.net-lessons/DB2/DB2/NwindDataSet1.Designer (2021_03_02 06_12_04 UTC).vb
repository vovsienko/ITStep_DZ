...
Partial Public Class NwindDataSet
    ...
    Partial Public Class CustomersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddCustomersRow(ByVal Company As String, ByVal Last_Name As String, ByVal First_Name As String, ByVal Job_Title As String) As CustomersRow
            Dim rowCustomersRow As CustomersRow = CType(Me.NewRow,CustomersRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Company, Last_Name, First_Name, Job_Title}
    ...
    Partial Public Class CustomersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Customers` WHERE ((`ID` = ?) AND ((? = 1 AND `Company` IS NULL) OR ("& _ 
                ...
                "(? = 1 AND `First Name` IS NULL) OR (`First Name` = ?)) AND ((? = 1 AND `Job Tit"& _ 
                "le` IS NULL) OR (`Job Title` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Customers` (`Company`, `Last Name`, `First Name`, `Job Title`) VALUE"& _ 
                "S (?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Customers` SET `Company` = ?, `Last Name` = ?, `First Name` = ?, `Job Tit"& _ 
                "le` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Company` IS NULL) OR (`Company` = ?))"& _ 
                " AND ((? = 1 AND `Last Name` IS NULL) OR (`Last Name` = ?)) AND ((? = 1 AND `Fir"& _ 
                "st Name` IS NULL) OR (`First Name` = ?)) AND ((? = 1 AND `Job Title` IS NULL) OR"& _ 
                " (`Job Title` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.DB2.MySettings.Default.NwindConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Company, [Last Name], [First Name], [Job Title] FROM Customers"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Company As String, ByVal Original_Last_Name As String, ByVal Original_First_Name As String, ByVal Original_Job_Title As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Company As String, ByVal Last_Name As String, ByVal First_Name As String, ByVal Job_Title As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Company As String, ByVal Last_Name As String, ByVal First_Name As String, ByVal Job_Title As String, ByVal Original_ID As Integer, ByVal Original_Company As String, ByVal Original_Last_Name As String, ByVal Original_First_Name As String, ByVal Original_Job_Title As String) As Integer
            If (Company Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_Company,String)
            End If
            If (Original_Last_Name Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_Job_Title,String)
            End If
